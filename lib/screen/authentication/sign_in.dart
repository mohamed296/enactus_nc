...
import 'package:enactusnca/components/edite_text.dart';
import 'package:enactusnca/screen/authentication/sign_up.dart';
...
class _SignInState extends State<SignIn> {
  ...
  Future signIn() async {
    ...
    helper_functions.setUserEmail(tecEmail.text);
    _databaseMethods.getUsersByUserEmail(tecEmail.text).then((val) {
      snapshot = val;
      final String name =
          '${snapshot.docs[0].data()["firstName"]} ${snapshot.docs[0].data()["lastName"]}';
      helper_functions.setUsername(name.toLowerCase().toString());
      helper_functions.setUserLoggedIn(isUserLoggedIn: true);
    });
