...
public class CustomSplashScreenView extends FrameLayout {
    ...
    private static final int ANIMATION_TIME_IN_MILLIS = 1500;
    ...
    public CustomSplashScreenView(Context context) {
        ...
        flutterLogo.setImageDrawable(getResources().getDrawable(R.mipmap.ic_launcher_foreground, getContext().getTheme()));
